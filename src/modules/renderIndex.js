...
function createHeroObj() {
  const heroImgSrc = "components/restaurant-components/images/programmers-pantry-hero.png";
  const heroImgAlt = "Programmers Pantry's open kitchen with chefs preparing meals.";
  const heroObj = {
    type: 'section', attributes: { id: 'hero-container' },
    children: [
      { type: 'img', attributes: { class: 'hero-image', src: heroImgSrc, alt: heroImgAlt } },
...
function createFeaturedInObj() {
  const tasteMastrSrc = "components/restaurant-components/images/taste-mastr.png";
  const goourmetGazeSrc = "components/restaurant-components/images/goourmet-gaze.png";
  const culinaryChroniclesSrc = "components/restaurant-components/images/culinary-chronicles.png";
  const tasteSphereSrc = "components/restaurant-components/images/taste-sphere.png";
  const flavorJourneySrc = "components/restaurant-components/images/flavor-journey.png";

  const featuredLogos = { type: 'div', attributes: {class: 'featured-in-logo-container'},
                          children: [
                            { type: 'img', attributes: { src: tasteMastrSrc } },
                            { type: 'img', attributes: { src: goourmetGazeSrc } },
                            { type: 'img', attributes: { src: culinaryChroniclesSrc } },
                            { type: 'img', attributes: { src: tasteSphereSrc } },
                            { type: 'img', attributes: { src: flavorJourneySrc } },
                          ]
                        }
